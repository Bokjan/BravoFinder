...
- **Versioning**: follows [SemVer](https://semver.org/) (MAJOR.MINOR.PATCH). The current version is `3.0.0` (first release); subsequent releases are tagged with git tags (e.g. `v3.0.0`).
